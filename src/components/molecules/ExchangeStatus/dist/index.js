    ...
    switch (text) {
        ...
        case "Подтвержден другим участником.":
            return (react_1["default"].createElement(core_1.Box, { className: classes.underBox },
                ...
                react_1["default"].createElement(core_1.Box, null,
                    ...
                    react_1["default"].createElement(ButtonItem_1["default"], { className: classes.btn, type: "border", size: "medium", onClick: handleAgreeExchangeClick }, "\u041C\u0415\u041D\u042F\u042E\u0421\u042C"))));
        ...
        case "Подтвержден. Ожидается трэк-номер.":
            return (react_1["default"].createElement(core_1.Box, { className: classes.underBox },
                ...
                react_1["default"].createElement("form", { onSubmit: handleSubmit(submit), className: classes.trackForm },
                    ...
                    react_1["default"].createElement(ButtonItem_1["default"], { className: classes.btnSave, btnType: "submit", type: "solid", size: "large" }, "\u0421\u041E\u0425\u0420\u0410\u041D\u0418\u0422\u042C"))));
        case "Доставляется":
            if (track_their) {
                ...
                return (react_1["default"].createElement(core_1.Box, { className: classes.underBox },
                    react_1["default"].createElement(core_1.Typography, { className: classes.explanation }, "\u041A\u0430\u043A \u0442\u043E\u043B\u044C\u043A\u043E \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u0432\u0432\u0435\u0434\u0435\u0442 \u0442\u0440\u0435\u043A-\u043D\u043E\u043C\u0435\u0440 \u043E\u043D \u043E\u0442\u043E\u0431\u0440\u0430\u0437\u0438\u0442\u0441\u044F \u0437\u0434\u0435\u0441\u044C."),
                    react_1["default"].createElement(core_1.Typography, { className: classes.explanation },
                        "\u0412\u044B \u0432\u0432\u0435\u043B\u0438 \u0442\u0440\u0435\u043A\u043D\u043E\u043C\u0435\u0440: ",
                        track_my)));
            }
        case "Завершен":
            return (react_1["default"].createElement(react_1["default"].Fragment, null, textTheir === 'Доставляется' ?
