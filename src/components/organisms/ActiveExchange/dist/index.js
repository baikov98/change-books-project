...
var ActiveExchange = function () {
    ...
    return (react_1["default"].createElement(core_1.Box, { className: classes.root },
        react_1["default"].createElement(core_1.Box, { className: classes.wrapper },
            ...
            !!NewToOldData.length &&
                NewToOldData.map(function (item, index) { return (react_1["default"].createElement(core_1.Box, { className: classes.contextBox, key: "contentLine-" + index + " - " + (item === null || item === void 0 ? void 0 : item.offerMyId) },
                    react_1["default"].createElement(core_1.Box, { className: classnames_1["default"](classes.contentLine, index === NewToOldData.length - 1 ? classes.last : "") },
                    ...
                    react_1["default"].createElement(core_1.Box, { className: classes.statusBox },
                        react_1["default"].createElement(core_1.Box, { className: classes.status },
                            react_1["default"].createElement(CatAndValue_1["default"], { valueBold: true, category: "Статус обмена", value: item === null || item === void 0 ? void 0 : item.status_my })),
