...
var Archive = function () {
    ...
    var data = react_redux_1.useSelector(selectors_1.getArchiveExchange);
    ...
    var handleClick = function (value) {
        history.push(routes_1.links.archiveCard(value.toString()));
    };
    return (react_1["default"].createElement(core_1.Box, { className: classes.root },
        react_1["default"].createElement(core_1.Box, { className: classes.wrapper },
            ...
            !!data.length &&
                data.map(function (item, index) { return (react_1["default"].createElement(core_1.Box, { className: classes.contextBox, key: "contentLine-" + index + " - " + (item === null || item === void 0 ? void 0 : item.offerMyId) },
                    react_1["default"].createElement(core_1.Box, { className: classnames_1["default"](classes.contentLine, index === data.length - 1 ? classes.last : "") },
                        react_1["default"].createElement(core_1.Box, { className: classes.book },
                            react_1["default"].createElement(BookList_1["default"], { data: item === null || item === void 0 ? void 0 : item.categories, title: "\u041A\u043D\u0438\u0433\u0430 #" + (item === null || item === void 0 ? void 0 : item.offerTheirId) })),
                        react_1["default"].createElement(core_1.Box, { className: classes.book },
                    ...
                    react_1["default"].createElement(core_1.Box, { className: classes.statusBox },
                        react_1["default"].createElement(core_1.Box, { className: classes.status },
                            react_1["default"].createElement(CatAndValue_1["default"], { valueBold: true, category: "Статус обмена", value: "Завершён" })),
