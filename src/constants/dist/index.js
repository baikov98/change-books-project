...
exports.VALIDATION = exports.baseURL = void 0;
var yup = require("yup");
var texts = {
...
exports.baseURL = '';
var emailMatches = /^(([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}){0,1}$/;
var nickNameMatches = /^([a-zA-Z][a-zA-Z0-9-_\.]+)|([А-Яа-я][А-Яа-я0-9-_\.]+){1,50}$/;
var passwordMatches = /^((?=.*?[A-Z])(?=.*?[a-z]))|((?=.*?[А-Я])(?=.*?[а-я]))(?=.*?[0-9])[a-zA-ZА-Яа-я\d]$/;
exports.VALIDATION = {
